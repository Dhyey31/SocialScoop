...
cloudinary.config({ 
	cloud_name: 'socialscoop', 
	api_key: '551879669269244', 
	api_secret: 'ccs3EtWV892AFcGq73_MISVGylk' 
  });
...
const start = async () => {
	try {
		await connectDB("mongodb+srv://DhyeyV:VivoZ1pro@cluster0.dkgmk.mongodb.net/socialScoop?retryWrites=true&w=majority");
		server.listen(PORT, () => {
